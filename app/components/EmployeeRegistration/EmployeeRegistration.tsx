...
import { Course, Employee } from "@/app/utils/types";
...
export const EmployeeRegistration: React.FC<EmployeeRegistrationProps> = ({courses, staff}) => {
  ...
  return (
    <article className="EmployeeRegistration">
      {staff && (<AsideMenu />)}

      <form
        className="EmployeeRegistration__form"
