    ...
    <div className='Learn'>
      ...
      <div className="Course_title">
        ...
        <div
          ...
          style={{ backgroundColor: changeProgressBackground(course?.courseProgress | 0) }}
        >
...

      {
        ...
        <Accordion defaultActiveKey="0">
           <ol type='1'>
        {
          course?.courseModules.map((courseModule: CourseModule, index) => (
            <li>
              <Accordion.Item eventKey={courseModule.moduleName} key={courseModule.moduleName}>              
                ...
                <ol type='a'>
                  {courseModule.moduleTopics.map((moduleTopic: ModuleTopic, index) => {
                    return (
